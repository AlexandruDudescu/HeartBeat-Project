...
namespace Heartbeat.Repositories
{
    public class HeartBeatTextRepository : IHeartBeatRepository
    {
        ...
        {
            using (StreamWriter writetext = new StreamWriter(@"C:\Users\Panda\Documents\Heartbeat\Heartbeat\Data.txt"))
            {
        ...
        public List<HeartBeat> GetAllHeartBeats()
        {
            ...
            using (StreamReader readtext = new StreamReader(@"C:\Users\Panda\Documents\Heartbeat\Heartbeat\Data.txt"))
            {
                string info = " ";
                while (info != null)
                {
